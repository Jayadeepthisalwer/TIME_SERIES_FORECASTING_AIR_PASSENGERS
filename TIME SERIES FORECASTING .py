...
df = pd.read_csv("D:\\DATA SCIENCE\\PROJECTS\\ALGORITHMS\\TIME SERIES FORECASTING\\AirPassengers.csv")
...
# Now, we wil discuss Stationary and Non-Stationary Time Series. Stationarity is a property of a time series.
# 
...
data = pd.read_csv('D:\\DATA SCIENCE\\PROJECTS\\ALGORITHMS\\TIME SERIES FORECASTING\\time series data.txt')
